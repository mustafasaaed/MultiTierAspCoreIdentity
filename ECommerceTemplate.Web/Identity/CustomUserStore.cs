...
namespace ECommerceTemplate.Web.Identity
{
        ...
        IQueryableUserStore<IdentityUser>
    {
        ...
        public Task<IList<IdentityUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken)
        {
            ...
            IList<IdentityUser> result = _unitOfWork.UserClaimRepository.GetUsersForClaim(claim.Type, claim.Value).Select(x => GetIdentityUser(x)).ToList();
        ...
        private User GetUserEntity(IdentityUser IdentityUser)
        {
        ...
        private void populateUserEntity(User entity, IdentityUser IdentityUser)
        {
        ...
        private IdentityUser GetIdentityUser(User entity)
        {
            if (entity == null)
                return null;
        ...
        private void PopulateIdentityUser(IdentityUser IdentityUser, User entity)
        {
